package com.ibairah.Easy.lc953VerifyinganAlienDictionary;
 ...
 * second string is shorter (in size.) According to lexicographical
 * rules "apple" > "app", because 'l' > '∅', where '∅' is defined
